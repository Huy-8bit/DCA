...
const JoinUs = () => {
  return (
    <div className="pt-[100px] bg-[#000]">
      <div className="w-full h-full bg-top  join_us relative px-4 pb-20 lg:py-0 lg:px-0">
        <Image
          src={bgStar}
          alt="start"
          className="top-[-100px] left-0 w-full h-full absolute"
        />
        <div className="content w-full lg:w-[1094px] h-full lg:h-[420px] mx-auto p-6 lg:p-[1px] relative z-[10]">
          <div className="bg-[rgba(0,0,0,0.75)] w-full h-full rounded-2xl flex items-center">
            <div className="w-full lg:w-[850px] mx-auto relative z-10">
              ...
              <p className="text-base text-[#fff] font-medium my-4 lg:my-8">
                DAC revolutionizes traditional venture capital by harnessing the
                collective strength and diversity of communities to drive
                innovation and foster inclusive growth. Join now to always get
                updated with exciting news!
              </p>
              <form className="flex flex-col items-end lg:flex-row lg:items-center justify-between gap-4">
                <div className="input_wrap w-full lg:w-[560px] h-[50px]">
                  <input
                    ...
                    className="input w-full h-full  py-[10px] px-6 placeholder:text-[#687176] text-[#fff]"
                  />
                </div>
        ...
        <Image
          src={line1}
          alt="line"
          className="absolute w-[200px] lg:w-[400px] -top-9 lg:top-[-50px] left-0"
        />
        <Image
          src={line2}
          alt="line"
          className="absolute top-[237px] lg:top-[66px] w-[265px] lg:w-[500px] right-0"
        />
